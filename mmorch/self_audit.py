...
def audit_module(module_rel: str, *, orch_root: str, today: str,
    ...
    out = llm_fn(
        ...
        "memoria (mismo bug que aparecio 3 veces esta semana: auto_repair, "
        "merge_train y project_repair actuaban con 1 corrida de retraso "
        "porque releian nightly.jsonl en vez de recibir el record actual); "
        "config/estado que vive en mas de un lugar; un modulo que podria "
        "reventar si otro cambia de forma silenciosa (acoplamiento oculto).\n"
