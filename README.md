...
<!-- mmorch:auto:stats -->
_Auto-generado por `mmorch.docgen`._ **120 módulos · 46 MCP tools · 634 tests.**
<!-- /mmorch:auto:stats -->
...
| `mmorch/docs_extract.py` | Extracción de texto de documentos (PDF hoy) para enriquecer el contexto |
