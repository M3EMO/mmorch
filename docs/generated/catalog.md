...
**121 módulos · 46 MCP tools · 915 tests.**

El server expone **16** de esas 46 con el perfil por default (`core`); `MMORCH_MCP_PROFILE=full` registra todas. Criterio y telemetría: `docs/cursor-setup.md`.
